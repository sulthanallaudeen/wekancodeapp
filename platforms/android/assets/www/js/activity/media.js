            ...
            success: function (message)
            {
                if (message.success == 1)
                {
                    ...
                    $.each(message.data, function( k, media ) {
                        var cover = appPath+'public/admin/images/gallary/'+media.cover+'/1.jpg';
                        html+='<div class="col s12 m6 grid"><figure class="effect-lily"><img src="'+cover+'" alt=""/><figcaption><div><h2>'+media.name+'</span></h2><p>Images of '+media.name+'</p></div><a href="media_images.html?id='+media.id+'">View more</a></figcaption>     </figure></div>';
                    });
                    //alert(html)
                    $("#medialist").html(html)
                } else
